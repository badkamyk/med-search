                ...
                <div
                    ...
                    <div>
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">You will have access to download the full
                                Figma project including all of the pages, the components, responsive pages, and also the
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Once you have purchased either the design,
                    ...
                    <div>
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">The free updates that will be provided is
                                based on the <a href="#"
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">You can use this version for any purposes,
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Although both Windster and Tailwind UI are
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Additionally, Windster is a project that is
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">Generally, it is accepted to use Windster in
                            ...
                            <p className="text-gray-500 dark:text-gray-400">With that being said, feel free to use this

...
export default function SearchPage() {
    ...
    const getMedData = async (name: string) => {
        const response = await fetch(`https://www.clinicaltrials.gov/api/query/study_fields?expr=${name}&fields=NCTId%2CBriefTitle%2CCondition%2CPrimaryOutcomeMeasure%2CLeadSponsorName%2CPrimaryCompletionDate&min_rnk=1&max_rnk=&fmt=json`);
    ...
    return (
        <div className="min-h-screen">
            ...
            {cardData.length > 0 && <Pagination className="flex justify-center items-center pb-3" currentPage={currentPage}
